...
namespace Cmentarz.DAL.Migrations
{
    ...
    [Migration("20230908104855_test11")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cmentarz.DAL.Models.Grobowiec", b =>
                {
                    ...
                    b.Property<int?>("WlascicielIdWlascicielID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("WlascicielIdWlascicielID");
            ...
            modelBuilder.Entity("Cmentarz.DAL.Models.Wlasciciel", b =>
                {
                    b.Property<int>("IdWlascicielID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("IdWlascicielID"));
            ...
            modelBuilder.Entity("Cmentarz.DAL.Models.Grobowiec", b =>
                {
                    ...
                    b.HasOne("Cmentarz.DAL.Models.Wlasciciel", null)
                        .WithMany("Grobowce")
                        .HasForeignKey("WlascicielIdWlascicielID");
                });
